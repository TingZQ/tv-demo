...
package com.tingzq.network.http.request;
import static com.tingzq.network.http.EasyHttp.getRetrofitBuilder;
import static com.tingzq.network.http.EasyHttp.getRxCache;
...
import com.tingzq.network.http.EasyHttp;
import com.tingzq.network.http.api.ApiService;
import com.tingzq.network.http.cache.RxCache;
import com.tingzq.network.http.cache.converter.IDiskConverter;
import com.tingzq.network.http.cache.model.CacheMode;
import com.tingzq.network.http.https.HttpsUtils;
import com.tingzq.network.http.interceptor.BaseDynamicInterceptor;
import com.tingzq.network.http.interceptor.CacheInterceptor;
import com.tingzq.network.http.interceptor.CacheInterceptorOffline;
import com.tingzq.network.http.interceptor.HeadersInterceptor;
import com.tingzq.network.http.interceptor.NoCacheInterceptor;
import com.tingzq.network.http.model.HttpHeaders;
import com.tingzq.network.http.model.HttpParams;
import com.tingzq.network.http.utils.HttpLog;
import com.tingzq.network.http.utils.RxUtil;
import com.tingzq.network.http.utils.Utils;
...
public abstract class BaseRequest<R extends BaseRequest> {
    ...
    public BaseRequest(String url) {
        ...
        if (baseUrl == null && url != null && (url.startsWith("com.tingzq.network.http://") || url.startsWith("https://"))) {

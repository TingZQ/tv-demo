...
import com.tingzq.network.http.cache.model.CacheResult;
import com.tingzq.network.http.callback.CallBack;
import com.tingzq.network.http.callback.CallBackProxy;
import com.tingzq.network.http.func.ApiResultFunc;
import com.tingzq.network.http.func.CacheResultFunc;
import com.tingzq.network.http.func.HandleFuc;
import com.tingzq.network.http.func.RetryExceptionFunc;
import com.tingzq.network.http.model.ApiResult;
import com.tingzq.network.http.subsciber.CallBackSubsciber;
import com.tingzq.network.http.transformer.HandleErrTransformer;
